...
enum class MediaGenres(val genre:String, val imageUrl:String, val genreId: Int) {
    ...
    DOCUMENTARY("Documentary","https://occ-0-8407-2219.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABYoxjccogSwfnlbt6lQscH0i6uyy-qdYbhkUK0uIGnSGntqOMQg2n6Euy_5uLzXuDH5xxIVOfcdIEMbwTta7wE7z_FA2NrphczkC.jpg?r=fb2",99),
    FAMILY("Family","https://www.indiewire.com/wp-content/uploads/2019/01/paddington2.jpg",10751),
